                  ...
                  <div className="space-y-3">
                    ...
                    <div className="p-4 bg-blue-500/10 border border-blue-500/30 rounded-xl">
                      ...
                      {currentHook.syBalance && (currentHook.syBalance as bigint) > 0n && (
                        <>
                          {/* Check if SY approval is needed */}
                          {syApprovalStatus.needsSYApproval ? (
                            <button
                              onClick={() => void currentHook.approveSYTokens(amount)}
                              disabled={!amount || isDepositing}
                              className="w-full px-4 py-3 bg-orange-600 hover:bg-orange-700 disabled:bg-gray-700 text-white rounded-lg font-semibold transition-colors mb-3"
                            >
                          ...
                          <div className="space-y-2 text-sm">
                            <div className="flex items-center space-x-2">
                              <div className={`w-2 h-2 rounded-full ${
                                currentHook.splitProgress.step === 'wrapping' || currentHook.splitProgress.step === 'waiting' 
                            ...
                            <div className="flex items-center space-x-2">
                              <div className={`w-2 h-2 rounded-full ${
                                currentHook.splitProgress.step === 'splitting' 
                    ...
                    {historyLoading ? (
                      ...
                      paginatedTransactions.map((tx) => (
                        <div
                          ...
                          className={`p-4 rounded-xl border transition-all duration-200 cursor-pointer hover:scale-[1.02] hover:shadow-lg ${
                            tx.status === 'success'
